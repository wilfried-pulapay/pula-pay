...
export default function OnboardingVerifyPhone() {
    ...
    const handleSkip = () => router.replace("/(main)/dashboard");
            ...
            <OtpVerificationCard
                ...
                footer={
                    <>
                        ...
                        <TouchableOpacity style={styles.linkRow} onPress={handleSkip}>
                            <Text style={[styles.linkText, { color: theme.colors.textMuted }]}>
                                {t("verifyPhone.skipForNow")}
                            </Text>
                        </TouchableOpacity>
                    </>
                }
    ...
    return (
        <Screen scroll style={styles.container}>
            <View style={styles.card}>
                ...
                <Text style={styles.subtitle}>{t("verifyPhone.onboardingSubtitle")}</Text>
                ...
                <TouchableOpacity style={styles.linkRow} onPress={handleSkip} disabled={loading}>
                    <Text style={[styles.linkText, { color: theme.colors.textMuted }]}>
                        {t("verifyPhone.skipForNow")}
                    </Text>
                </TouchableOpacity>
